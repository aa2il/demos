...
from tkinter import Tk, Frame, Menu, Button, Menubutton, Label
...
class Example(Frame):
    ...
    def initUI(self):
        ...
        # JBA - Add this to show how to combine into one line on the screen
        Label(toolbar,text='HEY').pack(side=LEFT, padx=2, pady=2)
        
        mb = Menubutton(toolbar,text='File')
        mb.pack(side=LEFT, padx=2, pady=2)
        mb.menu =  Menu ( mb, tearoff = 0 )
        mb["menu"]= mb.menu  
        mb.menu.add_command(label="Exit", command=self.onExit)
